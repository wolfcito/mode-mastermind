import { DidacticContentClasses, DidacticContentCoverflowCardProps } from "~~/components/carousel-didactic-content/interfaces";
...
export const DidacticContentCards: DidacticContentCoverflowCardProps[] = [
    ...
    },
    {
        ...
        description: "Dedicates time to practical testing, such as completing tutorials and making transactions in test environments.",
    ...
    },
    {
        ...
        description: "Ventures beyond the basics, seeking to understand the complexities and underlying protocols of blockchain.",
